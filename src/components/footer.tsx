      ...
      <section className="grid grid-cols-1 justify-start items-center md:mt-[40px] relative overflow-x-hidden md:px-[4%]">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mt-20 p-4">
          ...
          <div className="md:text-start">
            <h3 className="text-[17px] font-bold text-primary">Features</h3>
            <ul className="mt-6">
          ...
          <div className="md:text-start">
            <h3 className="text-[17px] font-bold text-primary">Company</h3>
            <ul className="mt-6">
              <li className="font-semibold py-2">
                <Link href="">Blog</Link>
              </li>
          ...
          <div className="md:text-start">
            <h3 className="text-[17px] font-bold text-primary">Help</h3>
            <ul className="mt-6">
              <li className="font-semibold py-2">
          ...
          <div  className="md:text-start">
            <h3 className="text-[17px] font-bold text-primary">Transpareny</h3>
            <ul className="mt-6">
              <li className="font-semibold py-2">
